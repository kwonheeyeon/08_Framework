...
public class ExampleController {
	...
	//							연결한 브라우저 종료 또는 세션 시간 만료까지 유지
	
	// 4) application - 서버 실행 시 한 개만 생성,
	//									서버가 종료될 때까지 유지
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// model을 이용해서 request scope에 값 세팅
	...
	public String ex2(Model model) {
		...
		// classpath:/templates/ex/result2.html 파일로 forward(요청 위임)
		return "ex/result2";
	}
