...
public class TodoListController {
	...
	// @ModelAttributes : 제출된 파라미터를 DTO 객체 필드에 대입
	//										-> 생략도 가능하다!!
	...
	public String todoUpdate(
		...
		if(result > 0) {
			...
			return "redirect:/todo/detail/" + todo.getTodoNo();
		}else {
			ra.addFlashAttribute("message", "수정 실패");
			return "redirect:/todo/update?todoNo=" + todo.getTodoNo();
		}
	...
	public String todoDelete(
		...
		if(result > 0) {
			...
			return "redirect:/todo/detail/" + todoNo;
		}
