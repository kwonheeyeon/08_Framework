...
public class MemberController {
	...
	@Autowired // 등록된 Bean 중에서 같은 타입의 Bean 대입(의존성 주입, DI)
	...
	public String login(
			...
			// @RequestParam의 required 속성 -> 기본값은 true : 무조건 제출되야 함
		...
		if(loginMember == null) { // 로그인 실패
			...
			// 2) 클래스 선언부에 위에 @SessionAttributes({"key"}) 추가
